...
MIGLE_BOOTDUET_COPY() {
	...
	install -D -m644 "${_MIGLE_BOOTDUET_COMPILE_DIR}"/bd*.bin "${UEFI_DUET_INSTALLER_DIR}/BootSector/"
	...
	install -D -m644 "${_MIGLE_BOOTDUET_COMPILE_DIR}/INSTALL" "${UEFI_DUET_INSTALLER_DIR}/Migle_BootDuet_INSTALL.txt"
	...
	install -D -m644 "${_MIGLE_BOOTDUET_COMPILE_DIR}/COPYING" "${UEFI_DUET_INSTALLER_DIR}/Licenses/Migle_BootDuet_LICENSE.txt"
