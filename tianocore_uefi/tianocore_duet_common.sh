...
COMPILED_DIR="${SOURCE_CODES_DIR}/Firmware/UEFI/UEFI_Compiled_Implementation/Tianocore_UEFI_DUET/"
EFI_DUET_GIT_DIR="${COMPILED_DIR}/Tianocore_UEFI_DUET_GIT/"
MEMDISK_COMPILED_DIR="${COMPILED_DIR}/Tianocore_UEFI_DUET_memdisk_compiled_GIT/"
MEMDISK_DIR="${COMPILED_DIR}/Tianocore_UEFI_DUET_memdisk_GIT/"
