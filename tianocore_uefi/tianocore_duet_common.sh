...
DUET_COMPILED_DIR="${SOURCE_CODES_DIR}/Firmware/UEFI/UEFI_Compiled_Implementation/Tianocore_UEFI_DUET_Builds/"
UEFI_DUET_INSTALLER_DIR="${DUET_COMPILED_DIR}/Tianocore_UEFI_DUET_Installer_GIT/"
DUET_MEMDISK_COMPILED_DIR="${DUET_COMPILED_DIR}/Tianocore_UEFI_DUET_memdisk_compiled_GIT/"
DUET_MEMDISK_TOOLS_DIR="${DUET_COMPILED_DIR}/Tianocore_UEFI_DUET_memdisk_tools_GIT/"
