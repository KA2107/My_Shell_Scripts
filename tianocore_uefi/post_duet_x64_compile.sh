...
MEMDISK_COMPILED_GIT() {
	...
	rm -rf "${DUET_MEMDISK_COMPILED_DIR}/Tiano_EDK2_DUET_X64.img" || true
	cp "${DUET_EMUVARIABLE_BUILD_DIR}/floppy.img" "${DUET_MEMDISK_COMPILED_DIR}/Tiano_EDK2_DUET_X64.img"
	# cp "${WD}/duet_x64_memdisk.bin" "${DUET_MEMDISK_COMPILED_DIR}/Tiano_EDK2_DUET_X64.img"
