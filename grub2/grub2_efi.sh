...
then
	...
	sed -i "s|grub.cfg|${GRUB2_EFI_MENU_CONFIG}.cfg|g" "${WD}/grub-core/normal/main.c" || true
	...
	sudo mkdir -p "${GRUB2_EFI_PREFIX}/etc/default"
	...
	sed -i "s|${GRUB2_EFI_MENU_CONFIG}.cfg|grub.cfg|g" "${WD}/grub-core/normal/main.c" || true
