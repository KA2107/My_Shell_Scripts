...
_GRUB2_BIOS_LINUX_MY="${_GRUB2_BIOS_LINUX} /dev/sda /boot/grub_Keshav grub /media/Data_3/grub_bios_backup /media/Data_3/grub_bios_utils_backup /_grub_Keshav_/bios/"
