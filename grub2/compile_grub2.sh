...
then
    export GRUB2_EFI_Source_DIR_Name=grub2_experimental_BZR
    export PROCESS_CONTINUE_UEFI="TRUE"
elif [ "${GRUB2_EFI}" == "-efi-main" ]
then
    export GRUB2_EFI_Source_DIR_Name=grub2_BZR
    export PROCESS_CONTINUE_UEFI="TRUE"
elif [ "${GRUB2_EFI}" == "-efi-install" ]
then
    export GRUB2_EFI_Source_DIR_Name="grub2_bzr_branches/grub2-bzr-install"
    export PROCESS_CONTINUE_UEFI="TRUE"
fi

if [ "${GRUB2_BIOS}" == "-bios-exp" ]
then
    export GRUB2_BIOS_Source_DIR_Name=grub2_experimental_BZR
    export PROCESS_CONTINUE_BIOS="TRUE"
elif [ "${GRUB2_BIOS}" == "-bios-main" ]
then
    export GRUB2_BIOS_Source_DIR_Name=grub2_BZR
    export PROCESS_CONTINUE_BIOS="TRUE"
fi
...
then
    ...
    rm -rf ${WD_Outer}/${GRUB2_EFI_Source_DIR_Name}/grub2_extras_BZR || true

    cp -r ${WD_Outer}/grub2_extras_BZR ${WD_Outer}/${GRUB2_EFI_Source_DIR_Name}/grub2_extras_BZR || true
    rm -rf ${WD_Outer}/${GRUB2_EFI_Source_DIR_Name}/grub2_extras_BZR/zfs || true
    rm -rf ${WD_Outer}/${GRUB2_EFI_Source_DIR_Name}/grub2_extras_BZR/915resolution || true
    rm -rf ${WD_Outer}/${GRUB2_EFI_Source_DIR_Name}/grub2_extras_BZR/ntldr-img || true
...
then
    ...
    rm -rf ${WD_Outer}/${GRUB2_BIOS_Source_DIR_Name}/grub2_extras_BZR || true

    cp -r ${WD_Outer}/grub2_extras_BZR ${WD_Outer}/${GRUB2_BIOS_Source_DIR_Name}/grub2_extras_BZR || true
    rm -rf ${WD_Outer}/${GRUB2_BIOS_Source_DIR_Name}/grub2_extras_BZR/zfs || true
    rm -rf ${WD_Outer}/${GRUB2_BIOS_Source_DIR_Name}/grub2_extras_BZR/915resolution || true
