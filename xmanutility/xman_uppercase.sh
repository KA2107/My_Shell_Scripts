# This file xman_uppercase is part of xman utility.
#
...
# Syntax: xman_uppercase FILE ...

# Given: A list of files/directories.
# Output: The list of files/directories are converted to uppercase.

# Known problems/limitations:

newline=$'\n'
FILTER="xman_toupper_filter"
FILTERNAME="Uppercase"

#########################################################################################

if [ -z "$1" ] ; then
	echo "usage: xman_uppercase FILE ..."
	exit 0
fi
