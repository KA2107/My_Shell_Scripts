...
sudo rm -f "/lib/modules/3.2.0-1-mainline/kernel/drivers/net/wireless/iwlwifi/iwlwifi.ko" || true
sudo rm -f "/lib/modules/3.2.0-1-mainline/kernel/drivers/net/wireless/iwlwifi/iwlwifi.ko.gz" || true
