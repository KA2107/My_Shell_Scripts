...
_GRUB_UEFI_LINUX_MY="${_GRUB_UEFI_LINUX} x86_64 /efisys /boot grub_uefi_x86_64 /media/Data_2/grub_uefi_x86_64_backup /media/Data_2/grub_uefi_x86_64_bootdir_backup /media/Data_2/grub_uefi_x86_64_utils_Backup /_grub_/grub_uefi_x86_64/"
